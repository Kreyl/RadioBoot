...
hdr.write("* Call usage:\n")
hdr.write("* *((FLASH_COPY_FN_TYPE)((unsigned int)__FLASH_COPY_FN + 1))(src_addr, dest_addr, size);\n")
hdr.write("*/\n\n")
hdr.write("#define FLASH_UPD_FN_SIZE                   " + str(len(h) / 2) + "\n\n")
hdr.write("extern const uint8_t __FLASH_UPD_FN[FLASH_UPD_FN_SIZE];\n\n")
hdr.write("typedef int (*FLASH_UPD_FN_TYPE)(uint32_t, uint32_t, unsigned int);\n\n")
...
src.write("const uint8_t __FLASH_UPD_FN[FLASH_UPD_FN_SIZE] = {\n")
